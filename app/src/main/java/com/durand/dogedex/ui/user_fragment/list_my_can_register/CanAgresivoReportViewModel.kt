...
class CanAgresivoReportViewModel(
    ...
    fun listar(id: Long) = viewModelScope.launch {
        ...
        try {
            Log.d("CanAgresivoReportViewModel", "Llamando repository.listarMascotaAgresiva()")
            val res: ApiResponseStatus<List<ListarCanResponse>> = repository.listarMascotaAgresiva(id)
